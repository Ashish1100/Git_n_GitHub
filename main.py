...
try:                                         # Optional for style, importing pyfiglet module
    ...
    print(f.renderText('Bharat Cheesecake'))
...
def get_name(shop_name = 'Bharat Cheesecakes'):
...
def order2(shop_name = 'Bharat Cheesecakes'):  # For ordering different types of items.
    print('')
